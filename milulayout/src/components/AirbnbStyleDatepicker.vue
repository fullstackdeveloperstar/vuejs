                ...
                <tr class="week" v-for="(week, index) in month.weeks" :key="index">
                  <td
                    ...
                    :class="{
                      ...
                      selected2:selectedDate2 === fullDate,
                      selected1: selectedDate1 === fullDate
                    }"
                    :style="{
                      width: (width - 30) / 7 + 'px',
...
import { debounce, copyObject, findAncestor, randomString } from './airbnb/helpers.js'
...
.airbnb-style-datepicker-wrapper {
  ...
  .day {
    ...
    &.selected{
      // background: #3d0355!important;
      // border: 1px double #3d0355!important;
    }


    &.in-range {
     background: #600c83!important;
      border: 1px double #600c83!important;
    }
...
.rtl .airbnb-style-datepicker-wrapper .month {margin-right: -50% !important;margin-left:auto!important;}

// .rtl .airbnb-style-datepicker-wrapper .month{margin-left}

.selected1:before {
    border-width: 0 0 36px 40px;
    border-color: transparent transparent #3e1855 transparent;
}

.selected2:before{
  border-width: 36px 40px 0 0;
  border-color: #3e1855 transparent transparent transparent;
}
...
.selected2{
  position: relative;
  background: #785d88!important;
  border: 1px double #785d88!important;
