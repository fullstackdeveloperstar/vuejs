...
.modal-container {width: 70%;margin: 0px auto;background-color: #fff;border-radius: 2px;box-shadow: 0 2px 8px rgba(0, 0, 0, .33);
  transition: all .3s ease;font-family: Helvetica, Arial, sans-serif;}
...
.modal-backdrop{	position: absolute;	width: 100%;	height: 100%;	top: 0;	left: 0;	z-index: -1;}
