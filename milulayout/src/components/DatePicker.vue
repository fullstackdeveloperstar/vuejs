...
.datepicker {
  ...
  &__wrapper {
    ...
    width: 100%;
    height: 48px;
    background: #3e1855 url('calendar_icon.regular.svg') no-repeat 17px center / 16px;
  }
  ...
  &__dummy-input {
    ...
    &--is-active { color: rgb(255, 233, 131); }
    &--is-active::placeholder { color: rgb(255, 233, 131);  }
    &--is-active::-moz-placeholder { color: rgb(255, 233, 131);  }
    &--is-active:-ms-input-placeholder { color: rgb(255, 233, 131);  }
    &--is-active:-moz-placeholder { color: rgb(255, 233, 131);  }
  ...
  &__month-day {
    ...
    &--selected {
      background-color: rgb(255, 233, 131);
      color: #3d0355;
    ...
    &--first-day-selected,
    &--last-day-selected {
      border-color: transparent transparent rgb(255, 233, 131);
      color: #3d0355;
      background: #c5aa75;
      ...
      &::before{
        ...
        border-color: transparent transparent rgb(255, 233, 131) transparent;
      }
    }
